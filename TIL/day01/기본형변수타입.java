...
public class 기본형변수타입 {
	...
	public static void f9(String[] args) {
		...
		//2.객체 생성
		//str1=new String("자바언어의 문법배우기");
		str1="자바언어의 문법배우기"; //컴파일타임에 저장된다.
		str2="자바언어의 문법배우기"; //이미 저장된 값을 사용한다.
		str3=new String("자바언어의 문법배우기"); //실행시 생성
		str4=new String("자바언어의 문법배우기"); //실행시 생성
