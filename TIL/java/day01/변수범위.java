...
//1.하나의 .java 파일에 여러 개의 class 가 올 수 있다.

public class 변수범위 {
	//1.멤버변수 : 자동초기화가 된다.
	//static 메서드에서 non-static 변수를 사용 불가(메모리에 올라오지 않음)
	...
	private static void f1() {
		//함수 내의 변수는 지역변수이다(stack에 저장된다). 반드시 초기화 후에 사용한다.
		int a=100;
